...
<body id="page-top">
   ...
   <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Sidebar - Brand -->
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashbord.html">
            <div class="sidebar-brand-icon rotate-n-15">
                <i class="fas fa-laugh-wink"></i>
            </div>
            <div class="sidebar-brand-text mx-3">CL ETUDIANT <sup>2</sup></div>
        </a>
        ...
        <li class="nav-item">
            <a class="nav-link" href="changmodpass.html">
                <i class="fas fa-fw fa-chart-area"></i>
                <span>changer mot de passe</span></a>
        </li>
         
        <li class="nav-item">
            <a class="nav-link" href="forgotmodpass.html">
                <i class="fas fa-fw fa-chart-area"></i>
                <span>oblier me de passe</span></a>
        </li>
        ...
        <!-- Nav Item - Pages Collapse Menu -->
        <li class="nav-item">
            <a class="nav-link" href="ecoles.html">
                <i class="fas fa-fw fa-chart-area"></i>
                <span>Ecoles</span></a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link" href="blannk.html">
                <i class="fas fa-fw fa-chart-area"></i>
                <span>Encienne concours</span></a>
        </li>
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-group-append">
                            <button class="btn btn-primary" type="button">
                                <i class="fas fa-search fa-sm"><img src="c:\Users\H\Downloads\loupe.png"></i>
                            </button>
                        </div>
                    </div>
                </form>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow mx-1">
                        <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="fas fa-bell fa-fw"><img src="c:\Users\H\Downloads\bouton-notifications.png"></i>
                            <!-- Counter - Alerts -->
                    ...
                    <li class="nav-item dropdown no-arrow mx-1">
                        <a class="nav-link dropdown-toggle" href="#" id="messagesDropdown" role="button"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="fas fa-envelope fa-fw"><img src="c:\Users\H\Downloads\notification.png"></i>
                            <!-- Counter - Messages -->
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                            ...
                            <img class="img-profile rounded-circle"
                                src="c:\Users\H\Downloads\utilisateur.png">
                        </a>
