...
<div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
  ...
  <div class="container">
    <h1>Techniques de préparation à l'entretien - Étapes</h1>
...
const etapes = [
  {
    titre: "Analyse de l'offre d'emploi",
    description: "Commencez par examiner attentivement l'offre d'emploi pour comprendre les responsabilités du poste, les compétences requises et les qualifications recherchées par l'employeur."
  },
  {
    titre: "Recherche sur l'entreprise",
    description: "Renseignez-vous sur l'entreprise en explorant son site web, ses publications sur les réseaux sociaux, ses actualités récentes et toute autre information pertinente. Comprenez sa mission, ses valeurs, sa culture d'entreprise, ses produits ou services, son marché et sa position concurrentielle."
  },
  {
    titre: "Préparation des réponses aux questions courantes",
    description: "Entraînez-vous à répondre aux questions courantes d'entretien telles que 'Parlez-moi de vous', 'Quels sont vos points forts et vos points faibles', 'Pourquoi voulez-vous travailler pour cette entreprise', etc. Préparez des réponses claires, concises et axées sur vos compétences et votre expérience."
  },
  {
    titre: "Identification et préparation des exemples concrets",
    description: "Identifiez des exemples concrets de situations passées où vous avez démontré les compétences et les qualités recherchées pour le poste. Utilisez la méthode STAR (Situation, Tâche, Action, Résultat) pour structurer vos réponses et assurez-vous de mettre en évidence vos réalisations et votre valeur ajoutée."
  },
  {
    titre: "Exercices de simulation d'entretien",
    description: "Pratiquez des exercices de simulation d'entretien avec un ami, un mentor ou un conseiller en carrière. Simulez des situations d'entretien réalistes et demandez des feedbacks constructifs sur votre communication verbale et non verbale, votre cohérence et votre capacité à répondre aux questions de manière convaincante."
  },
  {
    titre: "Révision de votre CV et lettre de motivation",
    description: "Passez en revue votre CV et votre lettre de motivation pour vous assurer qu'ils sont à jour, pertinents par rapport au poste et exempts d'erreurs. Soyez prêt à discuter en détail de votre expérience professionnelle, de vos réalisations et de vos compétences mentionnées dans votre CV."
  },
  {
    titre: "Préparation des questions à poser",
    description: "Préparez une liste de questions pertinentes à poser à l'intervieweur pour mieux comprendre le poste, l'entreprise et la culture d'entreprise. Posez des questions qui démontrent votre intérêt pour le rôle et votre volonté de contribuer positivement à l'entreprise."
  },
  {
    titre: "Planification logistique",
    description: "Planifiez les détails logistiques de l'entretien, tels que l'heure, le lieu (en personne ou virtuel), le moyen de transport, les documents à apporter, etc. Assurez-vous d'être ponctuel et bien préparé le jour de l'entretien."
  }
];
