        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Affichez les résultats de vos concours/entretiens:</h1>
                    ...
                    <body>
                        ...
                        emploi_stage.ID_Entreprise = '$id_ese' and resultat.resultat='en attent'
                        GROUP BY 
                            resultat.id_etud";
                                ...
                                <script>
                                  document.getElementById("sendButton").addEventListener("click", function() {
                                    ...
                                    if ($row["resultat"] === "Accepté") echo "Déjà était fait un action";
                                        ...
                                        echo "<a class='button' href='repoCandidat.php?id_etud=" . $row["id_etudiant"] . "&id_diplome=" . $row["ID_Offre"] . "&id_inscri=" . $row["id_inscription"] . "&action=Accepter&page=affiche'>Accepter</a>";
                                        echo "<br><a class='button refuse' href='repoCandidat.php?id_etud=" . $row["id_etudiant"] . "&id_diplome=" . $row["ID_Offre"] . "&id_inscri=" . $row["id_inscription"] . "&action=Refuser&page=affiche'>Refuser</a>";
                                    }
                                    
                                    echo "</td></td></tr>";
                                }
                              
                            }if ($result->num_rows < 0) echo "<tr><td colspan='9'>Aucune note trouvée.</td></tr>"; }else  echo "<tr><td colspan='9'>Aucune candidat trouvée.</td></tr>";
                            ?>
                        </table>
                    </body>
