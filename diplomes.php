...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Add new row or edit existing row
        ...
        // Check if ID_dip is set for editing
        if (isset($_POST['enregistre'])) {
            $nomDiplome = $_POST['nom_diplome'];
            $domaineEtude = $_POST['domaine_etude'];
            $dureeFormation = $_POST['duree_formation'];
            $niveauDiplome = $_POST['niveau_diplome'];
            $seuilSelection = $_POST['seuil_selection'];
            $idDiplome =$_POST['enregistre'];
            
            // foreach ($nomDiplome as $d => $f ) echo " the d is $d => ".var_dump($f);
            $niveauDiplome = $_POST['niveau_diplome'];
            $seuilSelection = $_POST['seuil_selection'];
            // Perform update operation
            $sql = "UPDATE diplomes SET Nom_Diplome='$nomDiplome[$idDiplome]', Domaine_Etude='$domaineEtude[$idDiplome]', duree_formation='$dureeFormation[$idDiplome]', Niveau_Diplome='$niveauDiplome[$idDiplome]', seuil_selection='$seuilSelection[$idDiplome]' WHERE ID_Diplome = $idDiplome";

            if ($conn->query($sql) === TRUE) {
             
            } else {
                echo '<script>alert("Erreur lors de le mise à jour  des données : ' . $conn->error . '");</script>';
            }
        } if(isset($_POST['enregistrer'])) {
            $nomDiplome = $_POST['NEWnom_diplome'];
            $domaineEtude = str_replace("'", "\'", $_POST['NEWdomaine_etude']);
            $dureeFormation = $_POST['NEWduree_formation'];
            $niveauDiplome = $_POST['NEWniveau_diplome'];
            $seuilSelection = $_POST['NEWseuil_selection'];

            $sql = "INSERT INTO diplomes (Nom_Diplome, Domaine_Etude, duree_formation, Niveau_Diplome, seuil_selection,ID_Ecole) VALUES ('$nomDiplome', '$domaineEtude', '$dureeFormation', '$niveauDiplome', '$seuilSelection','$id_ecole')";
    ...
    if (isset($_POST["Effacer"])) {
        ...
        $sql_delete_diplome = "Delete from diplomes  WHERE ID_Diplome = $id_diplome ";
...
$diplomes = [];
$sql = "SELECT *  FROM diplomes WHERE ID_Ecole = $id_ecole ";
$result = $conn->query($sql);
$count = 0;
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="diplomes.php"><i class="fas fa-graduation-cap"></i> Vos diplomes</a>
                        <a class="collapse-item" href="condidats.php"><i class="fas fa-user-graduate"></i> Les candidats inscrits </a>

                        <a class="collapse-item" href="afficheResulta.php"><i class="fas fa-fw fa-file-alt"></i> Publier les résultats</a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Votre diplomes : </h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <form method="post" action="diplomes.php" id="myForm">
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Duree duformation </th>
                                                <th>Niveau du diplome</th>
                                                <th>Seuil du selection</th>
                                                <th>Lancer inscription avec concour</th>
                                                <th>Lancer sans concour </th>
                                                <th>Action </th>
                                            </tr>
                                        </thead>
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th>Seuil du selection</th>
                                                <th>Lancer inscription avec concour</th>
                                                <th>Lancer inscription sans concour </th>
                                                <th>Action </th>
                                            </tr>
                                        </tfoot>
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($diplomes as $diplome) {
                                                $id = $diplome['ID_Diplome'];
                                                $_SESSION['ID_Dip']=$id; ?>
                                                <tr>
                                                    <td><input name="nom_diplome[<?php echo $id; ?>]" value="<?php echo $diplome['Nom_Diplome']; ?>"></td>
                                                    <td><input name="domaine_etude[<?php echo $id; ?>]" value="<?php echo $diplome["Domaine_Etude"]; ?>"></td>
                                                    <td><input name="duree_formation[<?php echo $id; ?>]" value="<?php echo $diplome["duree_formation"]; ?>"></td>
                                                    <td><input name="niveau_diplome[<?php echo $id; ?>]" value="<?php echo $diplome["Niveau_Diplome"]; ?>"></td>
                                                    <td><input name="seuil_selection[<?php echo $id; ?>]" value="<?php echo $diplome["seuil_selection"]; ?>"></td>
                                                    ...
                                                    <td><button class="cree_btn" type="submit" onclick="openForm('LancerSansCon', event)" name="LancerSansCon" id="yourButtonId" value="<?php echo (int)$diplome['ID_Diplome']; ?>"> <span>
                                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                                                                    <path fill="none" d="M0 0h24v24H0z"></path>
                                                                    <path fill="currentColor" d="M11 11V5h2v6h6v2h-6v6h-2v-6H5v-2z"></path>
                                                                </svg> Lancer
                                                    ...
                                                    <td>
                                                        <button class="editBtn" type="submit" name="enregistre" value="<?php echo $diplome['ID_Diplome']; ?>"> <svg height="1em" viewBox="0 0 512 512">
                                                        ...
                                                        <button class="bin-button" type="submit" name="Effacer" value="<?php echo $diplome['ID_Diplome']; ?>" onclick="deleteRow(this)"> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 39 7" class="bin-top">
                                            ...
                                            <tr id="newRowTemplate" style="display: none;">
                                                <td><input name="NEWnom_diplome" value="Nom de Diplome"></td>
                                                <td><input name="NEWdomaine_etude" value="Domaine d'étude"></td>
                                                <td><input name="NEWduree_formation" value="2"></td>
                                                <td><input name="NEWniveau_diplome" value="Bac+"></td>
                                                <td><input name="NEWseuil_selection" value="10"></td>
                                                <td><button class="cree_btn" type="submit" name="LancerAvecCon" value="<?php echo $diplome['ID_Diplome']; ?>"> <span>
                                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                                                                <path fill="none" d="M0 0h24v24H0z"></path>
                                                                <path fill="currentColor" d="M11 11V5h2v6h6v2h-6v6h-2v-6H5v-2z"></path>
                                                            </svg> Lancer
                                                        </span></button></td>
                                                <td><button class="cree_btn" type="submit" name="LancerSansCon" value="<?php echo $diplome['ID_Diplome']; ?>"> <span>
                                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                                                                <path fill="none" d="M0 0h24v24H0z"></path>
                                                                <path fill="currentColor" d="M11 11V5h2v6h6v2h-6v6h-2v-6H5v-2z"></path>
                                                            </svg> Lancer
    ...
    <div class="LancerSansCon form-popup" id="LancerAvecCon">
        ...
        <div class="content-form">
            ...
            <div class="form-group">
                    <label class="form-label" for="titre">Titre du Concours:</label>
                    <input class="form-input" type="text" id="titre" name="titre" required>
                </div> <div class="form-group">
                    <label class="form-label" for="location">Lieu du Concours:</label>
                    <input class="form-input" type="text" id="location" name="location" required>
                </div>
                <div class="form-group">
                    <label class="form-label" for="date">Date du Concours:</label>
                    <input class="form-input" type="date" id="date" name="date" required>
                </div>
                <div class="form-group">
                    <label class="form-label" for="heure">Heure du Concours:</label>
