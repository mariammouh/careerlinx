...
<body id="page-top">
    ...
    <div id="wrapper">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="diplomes.php"><i class="fa-solid fa-book-open"></i> Vos offres</a>
                        <a class="collapse-item active" href="condidats.php"><i class="fa fa-handshake"></i> Les candidats inscrits </a>
                        <a class="collapse-item " href="afficheResultaOffre.php"><i class="fas fa-fw fa-file-alt"></i>Publier les résultats</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Les candidats inscrits à vos offres:</h1>
                    ...
                    <body>
                        ...
                        <table>
                            <tr><th>CIN</th>
                                ...
                                <th>Note</th>
                                <th>Les fichiers soumis</th>
                                <th>Seuil de Sélection</th>
                                <th>Titre d'offre</th>
                                <th>Type d'offre</th>
                                <th>Avec Concours/entretien</th>
                                <th>Actions</th>
                            </tr>
                            <?php
        ...
        etudiant.CIN,
        etudiant.codeMassar,
        inscription_concour.fichier_necessaire,
        etudiant.id_etudiant,
        inscription_concour.ID_Diplome,
        inscription_concour.id_inscription,
        etudiant.niveau_academique,
        etudiant.date_naissance,
        etudiant.note,
        inscription_concour.id_concours,
        resultat.files,
        inscription_concour.seuil_selection,
        emploi_stage.Titre_Offre,
        emploi_stage.Type_Offre,
        resultat.resultat,
        emploi_stage.ID_Offre
    ...
    JOIN 
    emploi_stage ON inscription_concour.ID_Offre = emploi_stage.ID_Offre
      
    WHERE 
    emploi_stage.ID_Entreprise = '$id_ese'
    GROUP BY 
        resultat.id_etud";
                            ...
                            if ($result !== false) {
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo "<td>" . $row["nom"] . "</td>";
                                    echo "<td>" . $row["niveau_academique"] . "</td>";
                                    ...
                                    foreach ($files as $fich) {
                                        ...
                                        echo ' <a id="downloadLink" href="#" download>Telecharger ' . $f[0] . ' </a>
                ...
                <script>
                    ...
                    downloadLink.href = filePath;
                                    ...
                                    echo "</td>";
                                    echo "<td>" . $row["seuil_selection"] . "</td>";
                                    echo "<td>" . $row["Titre_Offre"] . "</td>";
                                    echo "<td>" . $row["Type_Offre"] . "</td>";
                                    // Check if id_concour is null
                                    $avec_concours = ($row["id_concours"] == null) ? "Non" : "Oui,";
                                    echo "<td>" . $avec_concours ;
                                    if($row["id_concours"] !== null){
                                        
                                    $con_info=getcon($row["id_concours"]);
                                    echo $con_info["type"];
                                    if($row["resultat"]===NULL ) {
                                    if($con_info["type"]==="Entretien à distance individual")
                                    echo '<form action="repoCandidat.php" method="get">
                                    <input type="url" id="textInput" placeholder="URL de Zoom, Teams, Google Meet" class="form-input" name="url">
                                  ...
                                  <script>
                                    document.getElementById("sendButton").addEventListener("click", function() {
                                      ...
                                      if (inputUrl) {
                                        var url = "repoCandidat.php?id_etud=' . urlencode($row["id_etudiant"]) . 
                                                  '&id_diplome=' . urlencode($row["ID_Offre"]) . 
                                                  '&Nom_Diplome=' . urlencode($row["Titre_Offre"]) . 
                                                  '&id_inscri=' . urlencode($row["id_inscription"]) . 
                                                  '&action=adistance&url=" + encodeURIComponent(inputUrl) + "&page=candida";
                                    ...
                                    echo"</td>";
                                    // Action buttons with student id and diploma id as parameters
                                    echo "<td>" ;
                                    if($row["resultat"]===NULL ) {
                                    echo"<a class='button' href='repoCandidat.php?id_etud=" . $row["id_etudiant"] . "&id_diplome=" . $row["ID_Offre"]. "&Nom_Diplome=" . $row["Titre_Offre"]. "&id_inscri=" . $row["id_inscription"] . "&action=Accepter&typ=$avec_concours&page=candida'>Accepter</a>";
                                    echo "<br><a class='button refuse' href='repoCandidat.php?id_etud=" . $row["id_etudiant"] . "&id_diplome=" . $row["ID_Offre"]. "&Nom_Diplome=" . $row["Titre_Offre"]. "&id_inscri=" . $row["id_inscription"] . "&action=Refuser$avec_concours&page=candida'>Refuser</a></td>";
                                    }else echo"Déjà était fait un action";
                                    echo "</tr>";
                                }
                            } else     echo "<tr><td colspan='9'>Aucune note trouvée.</td></tr>";
                            ?>
                        </table>
                    </body>
