            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="entretiens.php"><i class="fa fa-handshake"></i> Les candidats inscrits </a>
                        <a class="collapse-item active" href="diplomes.php"><i class="fa-solid fa-book-open"></i> Vos diplomes</a>
