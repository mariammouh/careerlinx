...
<li class="nav-item dropdown no-arrow">
    ...
    <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
        ...
        <a class="dropdown-item" href="home.php" data-toggle="modal" data-target="#logoutModal">
            ...
            <!-- End of Main Content -->
            <div class="container">
    <h1>Préparation au entretien</h1>
    <br>
    <br>
    <div class="part">
    <a href="questionEnt.php">
    <button class="button button-primary" style="height: 120px;">
      <img src="question.png" alt="Questions fréquemment posées" class="button-icon" style="width: 95px;">
      <span style="display: inline-block; line-height: 90px; font-size: 30px;">Questions fréquemment posées</span>
...
<br>
<div class="part">
    <a href="GestionStress.php">
        <button class="button button-secondary" style="height: 120px;">
            <img src="stress.png" alt="Questions fréquemment posées" class="button-icon" style="width: 95px;">
            <span style="display: inline-block; line-height: 90px; font-size: 30px;">Gestion du stress et de l'anxiété</span>
        </button>
    </a>
</div>
<br>
<div class="part">
    <a href="technique.php">
        <button class="button button-accent" style="height: 120px;">
            <img src="entretien-dembauche.png" alt="Questions fréquemment posées" class="button-icon" style="width: 95px;">
            <span style="display: inline-block; line-height: 90px; font-size: 30px;">Techniques de préparation à l'entretien</span>
