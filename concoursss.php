...
$username = "root";
$password = ""; // Laissez ce champ vide si vous utilisez les identifiants par défaut
$database = "careerlinx"; 
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Récupérer la valeur de l'école sélectionnée
    $school = $_POST['school'];
    
    // Si une école est sélectionnée, exécuter la requête avec cette condition
    if (!empty($school)) {
        // Sélectionner les concours de l'école sélectionnée
        $sql_select = "SELECT * FROM ancien_concours WHERE Nom_Concours LIKE '%$school%'";
    } else {
        // Si aucune école n'est sélectionnée, sélectionner tous les concours
        $sql_select = "SELECT * FROM ancien_concours";
    }
$data=[];
    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
            $data[]=$row;
            // echo "<tr>";
            // echo "<td>" . $row["ID_Ancien_Concours"] . "</td>";
            // echo "<td>" . $row["Nom_Concours"] . "</td>";
            // echo "<td>" . $row["Date_Concours"] . "</td>";
            // // Afficher le lien de téléchargement
            // echo "<td><a href='" . htmlspecialchars($row["contunue"]) . "' download>Télécharger PDF</a></td>";
            // echo "</tr>";
        }
    } else {
        ...
        <li class="nav-item">
            ...
            <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                ...
                <h6 class="collapse-header">Notre platforme offre :</h6>
                    <a class="collapse-item active" href="councours.php"><i class="fas fa-fw fa-folder"></i> Ancienne concours </a>
...
<div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
    ...
    <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
     <input value="<?php echo isset($_POST['school']) ? $_POST['school'] : 'ecole'; ?>" type="text" name="school" placeholder="Tous les écoles">
    <!-- <select name="school"  >
            <option value="">École</option>
            <option value="">École</option>
            <option value="ENA Architecture">ENA Architecture</option>
            <option value="fmp-marrakech">fmp-marrakech</option>
            <option value="fmp-rabat">fmp-rabat</option>
            <option value="fmp-fes">fmp-fes</option>
            <option value="ispits">ispits</option>
            <option value="ENSAM">ENSAM</option>
            <option value="ENSA">ENSA</option>
            <option value="encg-tafem">encg-tafem</option>
        </select> -->
        <button type="submit">Rechercher</button>
    </form>
</div>
<h2 style="margin:20px" >Les ancien concours sous form PDF </h2>
<table>
    <tr>
