        ...
        <div class="container"><a class="navbar-brand"  ><img src="logo.jpeg" height="80px" width="80px"> Careerlinx</a>
            ...
            <div id="my-nav" class="collapse navbar-collapse">
                ...
                <form class="form-inline my-2 my-lg-0">
                    <a href="signin.php" class="btn btn-outline-dark my-2 my-sm-0 mr-3 text-uppercase">se connecter</a> <a href="#" class="btn btn-info my-2 my-sm-0 text-uppercase">inscrire</a>
                </form>
            </div>
        </div>
    </nav>
    ...
    <footer class="container-fluid" id="gtco-footer">
        <div class="container">
            <div class="row">
                ...
                <form action="https://formsubmit.co/CareerLinx24@gmail.com" method="POST">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <ul class="nav follow-us-nav">
                                <li class="nav-item"><a class="nav-link" href="#"><i class="fa fa-facebook" aria-hidden="true"></i> CareerLink.ma</a></li><br>
                                <li class="nav-item"><a class="nav-link" href="#"><i class="fa fa-twitter" aria-hidden="true"></i> CareerLink.ma</a></li><br>
                                <li class="nav-item"><a class="nav-link" href="#"><i class="fa fa-google" aria-hidden="true"></i> CareerLink.ma </a></li><br>
                                <li class="nav-item"><a class="nav-link" href="#"><i class="fa fa-linkedin" aria-hidden="true"></i> CareerLink.ma</a></li><br>
                            </ul>
                        </div>
                        <div class="col-6">
                            <h4>Services</h4>
