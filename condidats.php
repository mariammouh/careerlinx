            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show " aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="condidats.php"><i class="fas fa-user-graduate"></i> Les candidats inscrits </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Les candidats inscrits  à l'inscription vos concours :</h1>
                    ...
                    <body>
                        ...
                        <table>
                            <tr><th>CIN</th>
                                ...
                                <th>Niveau du Diplôme</th>
                                <th>Avec Concours/Entretiens</th>
                                <th>Actions</th>
                            </tr>
                            <?php
        ...
        resultat.id_etud";
                            ...
                            if ($result !== false) {
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    foreach ($files as $fich) {
                                        ...
                                        echo ' <a id="downloadLink" href="' . htmlspecialchars($f[1]) . '" download>Telecharger ' . $f[0] . ' </a>
         ...
         ';
                                  ...
                                  <script>
                                    ...
                                    echo "<td>" ;
                                    if($row["resultat"]===NULL ) {
                                    echo"<a class='button' href='repoCandidat.php?id_etud=" . $row["id_etudiant"] . "&id_diplome=" . $row["ID_Diplome"]. "&Nom_Diplome=" . $row["Nom_Diplome"]. "&id_inscri=" . $row["id_inscription"] . "&action=Accepter&typ=$avec_concours&page=candida'>Accepter</a>";
                                    echo "<br><a class='button refuse' href='repoCandidat.php?id_etud=" . $row["id_etudiant"] . "&id_diplome=" . $row["ID_Diplome"]. "&Nom_Diplome=" . $row["Nom_Diplome"]. "&id_inscri=" . $row["id_inscription"] . "&action=Refuser$avec_concours&page=candida'>Refuser</a></td>";
