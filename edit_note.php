...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE note SET note_title='$note_title', contenu='$contenu' WHERE id_note=$id";


    if ($conn->query($sql) === TRUE) {
        header("Location: archive.php?message=updated");
        exit();
    } else {
...
<li class="nav-item">
    ...
    <label for="note_title">Titre de note:</label>
    <input type="text" id="note_title" name="note_title" value="<?php echo $note_title; ?>">
    <label for="contenu">Contenu de note :</label>
    <textarea id="contenu" name="contenu"><?php echo $contenu; ?></textarea>
