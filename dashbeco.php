                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Nombre de diplômes de votre établissement:</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Nombre d'inscriptions chaque année</h6>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Nombre d'étudiants inscrits X selon leur niveau académique.</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body ml-2">

                                    <div style="width: 300px; height: 300px;"><canvas id="pieChart" width="280" height="280"></canvas></div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="home8.php">Déconnexion</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <form action="profile.php" method="post" enctype="multipart/form-data">
                <div class="">
                    <div class="card">
                        ...
                        <h4><?php echo $donnes['Nom_Ecole'] ?></h4>
                    </div>
                    <div class="">
                        <div class="card">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="text" class="form-control" name="note" value="<?php echo $donnes['siteWeb'] ?>">
                                    </td>
                                </tr>
                                <tr>

                                    <td>
                                        <h6 class="">Nombre des étudiants </h6>
                                        <input type="text" class="form-control" name="note" value="<?php echo $donnes['nbr_étud'] ?>">
                                    </td>

                                    <td>
                                        <h6 class="">Nombre de filières :</h6>
                                        <input type="text" class="form-control" name="note" value="<?php echo $donnes['nbr_filière'] ?>">
                                    </td>
                                </tr>
                            </table>
                            <div class="err"></div>
